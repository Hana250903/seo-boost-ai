...
public partial class SEOBoostAIContext : DbContext
{
    ...
    /// <summary>
        /// Configures the DbContext to use SQL Server with the "DefaultConnection" connection string and sets query tracking behavior to NoTracking.
        /// </summary>
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(GetConnectionString("DefaultConnection")).UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);

    /// <summary>
    /// Configures the entity mappings, relationships, and constraints for the database context.
    /// </summary>
